...
%>
		...
		<div class="main_contents">
    		<div id="sub_content">
         <form action="StudentDeleteController" method="get" enctype="multipart/form-data" >
                ...
                <div class="col-md-4">
				    ...
				    <c:forEach items="${list }" var="list">
				   	 <div class="form-check-inline col-md-3">
				                        <input  class="form-check-input" <c:forEach  var="attend1" items="${sr.attend}" varStatus="loop">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                   <button type="button" class="btn btn-success col-md-2" data-bs-dismiss="modal" >Ok</button>
                                    <button type="button" class="btn btn-danger" onclick="location.href = 'studentSearch.jsp';">Cancel</button>
                                </div>
                            </div>
                        </div>
                    </div>
